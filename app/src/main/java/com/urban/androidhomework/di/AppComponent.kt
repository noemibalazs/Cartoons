...
@Singleton
@Component(modules = [AppModule::class, NetworkModule::class, RepositoryModule::class, ViewModelModule::class, PreferencesModule::class, LocalDataSourceModule::class])
